 ...
 */
export const postV0CityByCityNameExtmsgChildConversation = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameExtmsgChildConversationData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameExtmsgChildConversationResponses, PostV0CityByCityNameExtmsgChildConversationErrors, ThrowOnError>({
