...
func ComputePoolDesiredStates(
	...
	return computePoolDesiredStates(cfg, assignedWorkBeads, sessionBeads, scaleCheckCounts, nil, nil, readyAssigned)
}
...
func ComputePoolDesiredStatesTraced(
	...
	return computePoolDesiredStates(cfg, assignedWorkBeads, sessionBeads, scaleCheckCounts, nil, trace, readyAssigned)
}
...
func ComputePoolDesiredStatesWithDemandTraced(
	...
	return computePoolDesiredStates(cfg, assignedWorkBeads, sessionBeads, scaleCheckCounts, scaleCheckDemand, trace, readyAssigned)
}
