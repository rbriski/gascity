 ...
 */
export const postV0CityByCityNameBeadByIdReleaseIfCurrent = <ThrowOnError extends boolean = false>(options: Options<PostV0CityByCityNameBeadByIdReleaseIfCurrentData, ThrowOnError>) => (options.client ?? client).post<PostV0CityByCityNameBeadByIdReleaseIfCurrentResponses, PostV0CityByCityNameBeadByIdReleaseIfCurrentErrors, ThrowOnError>({
